  ...
  return (
    <View className="flex-1 bg-gray-50 p-6">
      ...
      <View className="flex-1 p-6 bg-white rounded-2xl  shadow shadow-blue-950/70 mb-6">
        <Text className="text-lg font-semibold text-gray-500 mb-2">Request From</Text>
        <FlatList
          data={contacts}
      ...
      >
        <Text className="text-white text-lg font-semibold">Request Money</Text>
      </TouchableOpacity>
